"""
ref: https://github.com/langchain-ai/langchain/blob/master/libs/community/langchain_community/callbacks/streamlit/streamlit_callback_handler.py#L18
Changed `_convert_newlines` to accomodate Anthropic-agents.
...
def _convert_newlines(text: Any) -> str:
